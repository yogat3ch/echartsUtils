...
e_tooltip_legend_dot <- function(background_color, color = "#000", border_radius = "10px", opacity = .2, height = "10px", width = "10px", margin_right = "4px", display = "inline-block", ...) {
...
e_tooltip_legend_rectangle <- function(background_color, color = "#000", opacity = .2, height = "10px", width = "20px", display = "inline-block", ...) {
